    ...
    <section id="contact" className="py-24 lg:py-32 bg-transparent section-divider">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            {submitted ? (
              <div className="bg-[var(--color-bg-secondary)] rounded-3xl p-10 text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-5 py-3.5 rounded-2xl bg-[var(--color-bg-secondary)] text-[var(--color-text-dark)] placeholder:text-[var(--color-outline)] focus:outline-none focus:ring-2 focus:ring-[var(--color-teal)]/40 transition-all duration-200 resize-none"
          ...
          >
            ...
            <div className="bg-[var(--color-bg-secondary)] rounded-3xl p-8 space-y-6">
              ...
              <div className="space-y-4">
                <a href="tel:0688886814" className="flex items-center gap-4 text-[var(--color-text)] hover:text-[var(--color-copper)] transition-colors group">
                  <div className="w-12 h-12 rounded-2xl bg-[var(--color-copper-faded)] flex items-center justify-center group-hover:bg-[var(--color-copper)] group-hover:text-white transition-all duration-300">
                  ...
                  <div>
                    <p className="font-medium">06.88.88.68.14</p>
                    <p className="text-sm text-[var(--color-text-muted)]">Appel ou SMS</p>
                  </div>
                </a>

                <a href="mailto:alchimiedesetoiles@gmail.com" className="flex items-center gap-4 text-[var(--color-text)] hover:text-[var(--color-copper)] transition-colors group">
                  <div className="w-12 h-12 rounded-2xl bg-[var(--color-teal-container)]/40 flex items-center justify-center group-hover:bg-[var(--color-teal)] group-hover:text-white transition-all duration-300">
                  ...
                  <div>
                    <p className="font-medium">alchimiedesetoiles@gmail.com</p>
                ...
                <div className="flex items-center gap-4 text-[var(--color-text)]">
                  <div className="w-12 h-12 rounded-2xl bg-[var(--color-gold-faded)]/50 flex items-center justify-center">
                  ...
                  <div>
                    <p className="font-medium">6 La Brairie</p>
            ...
            {/* Map placeholder */}
            <div className="bg-[var(--color-bg-surface-container)] rounded-3xl h-52 flex items-center justify-center overflow-hidden">
              <div className="text-center">
                <svg className="w-10 h-10 text-[var(--color-outline-light)] mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 6.75V15m6-6v8.25m.503 3.498l4.875-2.437c.381-.19.622-.58.622-1.006V4.82c0-.836-.88-1.38-1.628-1.006l-3.869 1.934c-.317.159-.69.159-1.006 0L9.503 3.252a1.125 1.125 0 00-1.006 0L3.622 5.689C3.24 5.88 3 6.27 3 6.695V19.18c0 .836.88 1.38 1.628 1.006l3.869-1.934c.317-.159.69-.159 1.006 0l4.994 2.497c.317.158.69.158 1.006 0z" />
                </svg>
                <p className="text-sm text-[var(--color-text-muted)]">La Brairie, Terre d'Étoiles</p>
                <p className="text-xs text-[var(--color-outline)]">Bocage Vendéen</p>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <a
                ...
                className="flex-1 flex items-center justify-center gap-3 py-3.5 rounded-2xl bg-[var(--color-bg-secondary)] hover:bg-[var(--color-teal-container)]/30 transition-all duration-300 text-[var(--color-text-muted)] hover:text-[var(--color-teal-dark)]"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-3 py-3.5 rounded-2xl bg-[var(--color-bg-secondary)] hover:bg-[var(--color-copper-faded)] transition-all duration-300 text-[var(--color-text-muted)] hover:text-[var(--color-copper)]"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
